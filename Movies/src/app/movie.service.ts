...
export class MovieService {
  ...
  getUpcomingMovies() {
    return this._http.get(this.url + 'discover/movie?primary_release_date.gte=2019-03-30&primary_release_date.lte=2019-05-15' + '&api_key=' + this.api_key + '&language=' + this.language + '&region=' + this.region);
  }

  getPopularMovies() {
    return this._http.get(this.url + 'discover/movie?sort_by=popularity.desc' + '&api_key=' + this.api_key + '&language=' + this.language + '&region=' + this.region);
  }
